...
#define NAN DBL_QNAN
#else
/* BEGIN GCC-XML MODIFICATIONS ($Date: 2007-10-31 15:08:50 $) */
# if defined(_MSC_VER)
static unsigned __int32 floatformat_nan[2] = {0xFFFFFFFF, 0x7FFFFFFF};
# define NAN (*(double*)floatformat_nan)
#else
# define NAN (0.0 / 0.0)
#endif
/* END GCC-XML MODIFICATIONS ($Date: 2007-10-31 15:08:50 $) */
#endif
#endif
